...
def select_hybrid_tickers(n_clusters, per_cluster, start_date="2023-01-01", end_date="2025-01-01", min_dollar_vol=2e6):
    """
    ...
    for cluster_id in range(n_clusters):
        ...
        if cluster_tickers:
            ...
            selected.extend(cluster_scores.head(per_cluster).index.tolist())
